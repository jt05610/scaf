...
var initCmd = &cobra.Command{
	Use:   "init",
	Short: "Initializes a new device with appropriate folder structure.",
	Long: `The 'init' command of scaf initializes a new robot by creating the required folder 
structure and config files based on the device description provided. This structure allows for efficient organization 
and operation of the diverse modules and services associated with the device.
...
- Initiate spaces for firmware, SolidJS microfrontend, and microservices related to the device.
